...
module.exports = class WDI5 {
     ...
     * @return {Boolean} successfull change of selected property
     */
    check() {
        const bResult = this._setProperty('selected', true);
     ...
     * @return {Boolean} successful or failed change of checkbox status
     */
    uncheck() {
        const bResult = this._setProperty('selected', false);
    ...
    toggle() {
        ...
        const bResult = this._setProperty('selected', !bState);
