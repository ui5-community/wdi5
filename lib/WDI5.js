...
module.exports = class WDI5 {
    ...
    _context = null;
    /** @type {sap.ui.test.RecordReplay.ControlSelector} */
     ...
     * @param {WebdriverIO.BrowserObject} context
     * @return {[String, Object | String]} success | error | unknown, ui5Control {WebdriverIO.Element} | error message
     */
