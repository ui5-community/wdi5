...
module.exports = {
     ...
     * @param {*} pluginConf
     */
    _injectPlugins: function (pluginConf) {
        ...
        const result = this._context.executeAsync((sPluginConf, done) => {
            ...
            try {
                ...
                window.wdi5.getPluginConfigForPlugin = function (pluginName) {
                    return wdi5.plugins[pluginName];
                };
                window.wdi5.getPluginConfigForPluginWithProperty = function (pluginName, property) {
                    return wdi5.plugins[pluginName][property];
                };
                done(true);
            } catch (e) {
                done(false);
