 ...
 * Be aware that the context differs inside the passed function to factory.registerPlugin to this files' context.
 * This means, that eg. the member `_pluginName` is not available.
 * 1. function window.wdi5.getPluginConfigForPluginWithProperty(pluginName, property) can be used to retrieve a property form
 * the plugin config.
 * OR
...
module.exports = (() => {
    ...
    // register mock plugin implementation on factory -> the passed function will be executed in the webcontext
    // and thus all defined objects will be attached to the webcontext
    _register = () => {
