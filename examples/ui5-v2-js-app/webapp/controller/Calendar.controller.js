sap.ui.define(
    ...
    function (Controller, JSONModel, MessageBox) {
        ...
        return Controller.extend("test.Sample.controller.Calendar", {
            onInit: function () {
                // create model
                    ...
                    people: [
                        {
                            ...
                            appointments: [
                                ...
                                },
                                {
                                    ...
                                    title: "Meeting of the day",
                                    info: "Special meeting",
                                    type: "Type04",
                                    tentative: false
                                },
                                {
                ...
                if (oAppointment) {
                    ...
                    MessageBox.show(
                        "'" +
                            ...
                            this.byId("PC1").getSelectedAppointments().length
                    )
                } else {
